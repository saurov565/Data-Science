...
df <- read.csv("/Users/abulbasharsaurov/Downloads/Supermarket_Sales.csv", header = TRUE, na.strings = c("NAN", "         NAN"))
...
# load the data set
df <- read.csv("/Users/abulbasharsaurov/Downloads/Supermarket_Sales.csv")
